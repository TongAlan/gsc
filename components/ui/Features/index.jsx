...
const Features = () => {
    ...
    const features = [
        ...
        },
        {
            ...
            desc: "At Giant Springs Consulting our mission is to raise the bar by making computer security a priority."
        }
    ]
