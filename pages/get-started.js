...
export default function GetStarted() {
  ...
  return (
    <>
      <Head>
        <title>Contact us - Giant Springs</title>
      </Head>
          ...
          <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
            <div className="max-w-lg sm:text-center lg:text-left">
              <h1 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
                Talk to a GSC expert
              </h1>
              <p className="mt-3">
                We are here to help. Get in touch by shooting us an email at{" "}
                <a
                  href="mailto:support@giantspringsconsulting.com"
                  target="_blank"
                  rel="noreferrer"
                  className="text-indigo-600 hover:text-indigo-400 font-medium duration-150"
                >
                  support@giantspringsconsulting.com.
                </a>
              </p>
            </div>
